...
class Song:
    def __init__(self, name: str, song_artist: str, mapper: str,
        ...
        title_surface: pygame.Surface = get_font("./assets/hanyisongjian.ttf", 36).render(self.name, True, (0, 0, 6))
        ...
        if not is_from_osu_file:
            details_surface: pygame.Surface = get_font("./assets/hanyisongjian.ttf", 24).render(f"Song by {self.song_artist} | Mapped by {self.mapper}", True, (0, 0, 0))
        else:
            details_surface: pygame.Surface = get_font("./assets/hanyisongjian.ttf", 24).render(f"WARNING: EXPERIMENTAL!!!", True, (0, 0, 0))
...
class SongSelector:
    ...
    def __init__(self):
        ...
        self.play_button_text = get_font("./assets/hanyisongjian.ttf", 48).render("开始游戏", True, (0, 0, 0))
        self.back_button_rect = pygame.Rect(Config.SCREEN_WIDTH - 300, 20, 250, 150 - 40)
        self.back_button_text = get_font("./assets/hanyisongjian.ttf", 48).render("返回", True, (0, 0, 0))
